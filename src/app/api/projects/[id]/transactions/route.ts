...
import { getPaymentTransactions } from "@/lib/services/payment.service";
...
// GET /api/projects/[id]/transactions — Get payment transactions
export async function GET(
  ...
  try {
    ...
    // IDOR fix: verify ownership before returning transactions
    ...
    const data = await getPaymentTransactions(id);
