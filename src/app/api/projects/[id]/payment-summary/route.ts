...
// GET /api/projects/[id]/payment-summary — Get computed payment summary
export async function GET(
  ...
  try {
    ...
    // IDOR fix: verify ownership before returning payment summary
    ...
    const data = await getPaymentSummary(id);
