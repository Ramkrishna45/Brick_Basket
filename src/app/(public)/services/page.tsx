          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            {SERVICES_LIST.map((service, i) => (
              <motion.div
                ...
                className="group flex gap-5 p-6 rounded-2xl border border-slate-200 bg-white hover:border-amber-300 hover:shadow-md transition-all"
              >
                <div className="flex h-12 w-12 items-center justify-center rounded-xl bg-amber-50 group-hover:bg-amber-100 transition-colors flex-shrink-0">
                  <service.lucideIcon className="h-6 w-6 text-amber-600" />
                </div>
                <div className="flex-1">
                  <h2 className="text-lg font-semibold text-slate-900 mb-2">{service.title}</h2>
                  <p className="text-slate-500 text-sm mb-4 leading-relaxed">{service.description}</p>
                  <div className="mb-4">
                    <div className="text-xs font-semibold text-slate-700 uppercase tracking-wide mb-2">Includes</div>
                  ...
                  <div className="flex items-center justify-between">
                    <div className="bg-amber-50 px-3 py-1.5 rounded-lg">
                      <span className="text-xs text-amber-700 font-medium">Ideal for: </span>
                      <span className="text-xs text-amber-600">{service.idealFor}</span>
                    </div>
                  </div>
                </div>
              </motion.div>
