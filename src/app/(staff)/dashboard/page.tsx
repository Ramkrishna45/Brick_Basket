  ...
  if (projects.length === 0) {
    return (
      <div className="flex flex-col items-center justify-center py-24 text-center">
        ...
        <h2 className="text-xl font-bold text-slate-900">No Assigned Projects</h2>
  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-slate-500 mt-1">Manage and track the projects you are currently supervising.</p>
      </div>
                ...
                <CardContent className="p-6">
                  ...
                  <div className="grid grid-cols-2 gap-4 mb-6">
                    <div className="bg-slate-50 p-3 rounded-lg">
                      ...
                      <div className="text-sm font-semibold text-slate-900">{stageLabel}</div>
                    </div>
                    <div className="bg-slate-50 p-3 rounded-lg">
                      <div className="flex items-center gap-1.5 text-xs text-slate-400 mb-1">
                        <Calendar className="h-3 w-3" /> Target Date
                      </div>
                      <div className="text-sm font-semibold text-slate-900">{expectedCompletionDate}</div>
                    </div>
                  </div>
                  ...
                  <div className="mb-6">
                    <div className="flex justify-between text-sm mb-2">
                      ...
                      <span className="font-bold text-amber-600">{project.completionPercentage}%</span>
                    </div>
