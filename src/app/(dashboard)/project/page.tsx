                            ...
                            <div className="flex items-center gap-2 flex-wrap">
                              <span className={cn("font-semibold text-sm",
                                milestone.status === "completed" ? "text-slate-700"
                                  : milestone.status === "in_progress" ? "text-amber-700"
                                  : "text-slate-400"
                              )}>
                                {milestone.title}
                              </span>
                              {milestone.status === "in_progress" && (
                                <Badge className="bg-amber-50 text-amber-700 border-amber-200 text-xs py-0">Active</Badge>
                              )}
                            </div>
                        ...
                        {isExpanded && milestone.notes && (
                          ...
                          >
                            <div className="bg-amber-50 border border-amber-100 rounded-lg p-3 mt-1">
                              <div className="text-xs font-medium text-amber-800 mb-1">Engineer Notes</div>
