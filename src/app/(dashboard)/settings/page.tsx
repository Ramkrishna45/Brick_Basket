              ...
              <CardContent className="space-y-4">
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  ...
                  <div className="space-y-2">
                    ...
                    <p className="text-xs text-slate-500 dark:text-slate-400">Contact support to change email.</p>
                  </div>
                  <div className="space-y-2">
              ...
              <CardContent className="space-y-6">
                <div className="flex items-center justify-between">
                  <div className="space-y-0.5">
                    ...
                    <p className="text-sm text-slate-500 dark:text-slate-400">Receive emails when milestones are completed.</p>
                  </div>
                ...
                <div className="flex items-center justify-between">
                  <div className="space-y-0.5">
                    ...
                    <p className="text-sm text-slate-500 dark:text-slate-400">Get photos and quick updates on WhatsApp.</p>
                  </div>
                  <div className="relative inline-flex h-6 w-11 items-center rounded-full bg-amber-600 transition-colors cursor-pointer">
                    <span className="inline-block h-4 w-4 translate-x-6 rounded-full bg-white dark:bg-slate-950 transition-transform" />
                  </div>
                ...
                <div className="flex items-center justify-between">
                  <div className="space-y-0.5">
                    ...
                    <p className="text-sm text-slate-500 dark:text-slate-400">Get text messages for payments and critical alerts.</p>
                  </div>
