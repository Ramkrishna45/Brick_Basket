          ...
          <Link href="/admin" className="flex items-center gap-2.5">
            ...
            <div>
              <div className="flex items-center gap-1.5">
                <span className="font-bold text-slate-900 dark:text-slate-100 text-sm leading-tight">{BRAND.name}</span>
                <Badge className="bg-amber-100 text-amber-700 dark:text-amber-400 border-amber-200 text-xs py-0 px-1.5">Admin</Badge>
              </div>
              <div className="text-xs text-slate-500 dark:text-slate-400">Operations Portal</div>
            </div>
          </Link>
        </SidebarHeader>
            ...
            <DropdownMenuTrigger asChild><div className="flex items-center gap-3 w-full p-2.5 rounded-lg hover:bg-slate-100 dark:bg-slate-900 transition-colors text-left border border-transparent hover:border-slate-200 dark:border-slate-800 cursor-pointer">
              <Avatar className="h-8 w-8 flex-shrink-0 pointer-events-none">
                ...
                <div className="flex-1 min-w-0 pointer-events-none">
                  ...
                  <div className="text-xs text-amber-600 dark:text-amber-500 font-medium truncate capitalize">{user?.role}</div>
                </div>
